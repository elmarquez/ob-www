...
import PhytoplanktonImage from '../../public/images/phytoplankton.png';
              ...
              <div className="flex items-center justify-center lg:justify-end">
                <div className="h-64 w-64 m-4 md:h-96 md:w-96">
                  <div className="overflow-hidden border-gray-800 border-4 h-full w-full rounded-full aspect-w-1 aspect-h-1">
                    <Image className={'h-full w-full'} src={PhytoplanktonImage} alt={"Learn more about how phytoplankton"} />
                  </div>
                </div>
              </div>
              <div className="pt-6 pb-6 text-left">
                <div className="max-w-md lg:pt-8">
                  ...
                  <p className="mt-3 text-sm text-gray-500">
                    Learn more about <Link href="#" className={'text-purple-400 underline'}>phytoplankton</Link>.
                  </p>
                </div>
              </div>
            </div>
