...
import MilestonesDiagram from '../../public/images/milestones.svg';
    ...
    <div className="relative bg-white py-16 sm:py-24 lg:py-32">
      <div className="mx-auto max-w-md px-4 text-center sm:max-w-3xl sm:px-6 lg:px-8 lg:max-w-7xl">
        ...
        <div className="mt-12 flex flex-col justify-center items-center">
          <Image src={MilestonesDiagram} alt="Milestones" className={'lg:h-full lg:max-h-96'} />
        </div>
        <div className="mt-12">
            ...
            <div className="pt-6">
              <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Certify Process</h3>
            ...
            <div className="pt-6">
              <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">First Customers</h3>
                  <p className="mt-5 text-base text-gray-500">
            ...
            <div className="pt-6">
              <div className="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                <div className="-mt-6">
                  ...
                  <h3 className="mt-8 text-lg font-medium text-gray-900 tracking-tight">Scale Up</h3>
                  <p className="mt-5 text-base text-gray-500">
