...
import AupPhoto from '../../public/images/aup.png';
            ...
            <div className="h-80 w-full absolute bottom-0 xl:inset-0 xl:h-full">
                <div className="h-full w-full xl:grid xl:grid-cols-2">
                    <div className="h-full xl:relative xl:col-start-2">
                        <Image
                            className="min-h-full min-w-full h-full w-full object-cover opacity-25 xl:absolute xl:inset-0"
                            src={AupPhoto}
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8 xl:grid xl:grid-cols-2 xl:grid-flow-col-dense xl:gap-x-8">
                <div className="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
                    ...
                    <p className="mt-5 text-lg text-gray-300">
                        ...
                        <Link href={'/science/phytoplankton'} className={'text-purple-400 underline'}>massive phytoplankton blooms</Link>.{' '}
