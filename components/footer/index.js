...
import OceanBasedLogo from '../../public/images/ocean-based-logo-gray.png';
      ...
      <div className="max-w-md mx-auto pt-12 px-4 sm:max-w-7xl sm:px-6 lg:pt-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            {/* <Image className="h-10 opacity-50" src={OceanBasedLogo} alt="Ocean Blooms" /> */}
            <p className="text-gray-500 text-base">
              Massively scalable, low cost carbon sequestration that revitalizes the ocean
            </p>
            <div className="flex space-x-6">
              <a href="https://www.youtube.com/channel/UCyfZBOeyZQxvFdK6sujQ7ww" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://www.instagram.com/oceanbloomsco/" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://github.com/ocean-blooms" className="text-gray-400 hover:text-gray-500">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <Link href="/" className="text-base text-gray-500 hover:text-gray-900">About Us</Link>
                  </li>
                  <li>
                    <Link href="/" className="text-base text-gray-500 hover:text-gray-900">Blog</Link>
                  </li>
                  <li>
                    <Link href="/" className="text-base text-gray-500 hover:text-gray-900">Opportunities</Link>
                  </li>
                  <li>
              ...
              <div className="mt-12 md:mt-0">
                ...
                <ul className="mt-4 space-y-4">
                  ...
                  <li>
                    <Link href="/" className="text-base text-gray-500 hover:text-gray-900">California Privacy Act</Link>
                  </li>
                  <li>
