        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <div className="flex space-x-6">
              ...
              <a href="https://www.instagram.com/oceanbasedclimatesolutions" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://twitter.com/oceanbasedcs" className="text-gray-400 hover:text-gray-500">
              ...
              <a href="https://github.com/ocean-based" className="text-gray-400 hover:text-gray-500">
