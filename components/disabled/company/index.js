  ...
  return (
    <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
      ...
      <div className="mt-8 grid grid-cols-2 gap-0.5 md:grid-cols-3 lg:mt-0 lg:grid-cols-2">
        ...
        <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
          <Image className="max-h-12" src="https://tailwindui.com/img/logos/mirage-logo-gray-400.svg" alt="Mirage" />
        </div>
        <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
          <Image className="max-h-12" src="https://tailwindui.com/img/logos/tuple-logo-gray-400.svg" alt="Tuple" />
        </div>
        <div className="col-span-1 flex justify-center py-8 px-8 bg-gray-50">
          <Image
            className="max-h-12"
  ...
  return (
    <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8 pt-8 pb-8">
      ...
      <div className="lg:col-span-2">
        <Image src={MilestonesDiagram} alt="Milestones" />
      </div>
    </div>
  );
}
