...
import UnsplashImg from '../../public/images/photo-1507207611509-ec012433ff52.jpeg'
  ...
  return (
    <ContentLayout>
        <div className="bg-blue-gray-50">
          {/* Cards */}
          <section
            className="-mt-32 max-w-md mx-auto z-10 px-4 sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8"
            ...
            <div className="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
              {supportLinks.map((link) => (
                <div key={link.name} className="flex flex-col bg-white rounded-2xl shadow-xl">
                  <div className="flex-1 pt-16 px-6 pb-8 md:px-8">
